...
#define IR_LED   13 // 4    // light source
#define TSL_S1   12    // S1 and S0 are pins on the TSL230R chip
#define TSL_S0   11
#define TSL_FREQ 4  //13    // frequency signal from the sensor
#define BPIN     A5    // external button
#define BUTTON_EVENT_VALUE 500
 ...
 */
  ...
  if(sufficient_battery){
    ...
    if (bpress >= BUTTON_EVENT_VALUE || serialInput == 'r'){
      bpressed = true;
      Serial.println("before divisionfactor");
      divisionFactor_TSL230R();                
      Serial.println("after divisionfactor\n");
